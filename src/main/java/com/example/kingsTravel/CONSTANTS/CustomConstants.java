...
public class CustomConstants {
    ...
    public static final String CAT_DUPLICATE = "Category already exists";
    public static final String CAT_POSTED = "Category successfully saved";
    public static final String CATIMAGE_ERROR = "Image not saved";
